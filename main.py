...
def on_overlap_tile(sprite, location):
    if Level == 1:
        Devil2.say("Go into the void", 1000)
...
def on_overlap_tile2(sprite2, location2):
    ...
    if Level == 0:
        ...
        tiles.set_tilemap(tilemap("""
            Level2
        """))
        mySprite.set_position(80, 120)
        Devil2.set_position(120, 100)
    Level += 1
scene.on_overlap_tile(SpriteKind.player,
...
def on_overlap_tile3(sprite3, location3):
    global Class, mySprite, Level, statusbar
    if Level == 1:
        mySprite.destroy()
        Devil2.destroy()
        tiles.set_tilemap(tilemap("""
        ...
        """))
        mySprite.set_position(80, 120)
        controller.move_sprite(mySprite, 40, 40)
...
def on_overlap_tile4(sprite4, location4):
    if Level == 0:
        Devil2.say("Follow me", 500)
        
        def on_start_cutscene():
            story.sprite_move_to_location(Devil2, 245, 120, 40)
